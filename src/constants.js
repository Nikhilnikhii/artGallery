export const URL1 =
  "https://api.artic.edu/api/v1/artworks?fields=id,title,artist_display,date_display,main_reference_number,thumbnail,dimensions&limit=10&page=";
export const URL2 = "https://api.artic.edu/api/v1/artworks/";
